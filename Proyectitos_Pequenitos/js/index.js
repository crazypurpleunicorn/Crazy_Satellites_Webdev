...
/*SETTERS...i am interseted in being able to change "var vector" since it is the vector used to display the graph
...
var titleText = 
  'Monthly ' + 
  colorText('Purchases', 0) + 
  ' vs. ' + 
  colorText('Rent', 1);
var vector=[ [1, 29.9], [2, 97.5], [3, 110.4], [4, 129.2], [5, 144.0], [6, 176.0]]
